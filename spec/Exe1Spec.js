describe('Exercício 1 - Tags HTML5', () => {
    ...
    describe('Texto', () => {
        ...
        it('texto deve estar escrito corretamente', () => {
            ...
            .withContext('Escreva exatamente o que está descrito no enunciado.')
            .toBe('Desde 1999, o desenvolvimento da linguagem HTML (HyperText Markup Language) ficou estacionado na versão 4. De lá pra cá, a W3C esteve focada em linguagens como XML (Extensible Markup Language) e SVG (Scalable Vector Graphics). Mas finalmente, a partir de 2008, a HTML5 começou a ser desenvolvida e hoje é a versão dominante.')
        })
        ...
        it('deve conter um texto sublinhado', () => {
            ...
            expect(ins)
            .withContext('Use uma tag que deixe sublinhado, mas que não seja a <u> (spoiler: vou dar de graça: é o <ins>).')
            .toBeTruthy()
    ...
    describe('Citação', () => {
        ...
        it('deve utilizar a tag correta',() => {
            expect(this.quote)
            .withContext('Utilize a tag correta para fazer citações em documentos HTML (é o <blockquote>).')
            .toBeTruthy()
        })
        ...
        it('Citação deve conter autor', () => {
            ...
            expect(cite)
            .withContext('Utilize a tag mais adequada para marcar o autor original da citação (é o <cite>).')
            .toBeTruthy()
